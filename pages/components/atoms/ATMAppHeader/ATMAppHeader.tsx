...
import AdminChangePasswordFormWrapper from "../../layouts/ChangePassword/AdminChangePasswordFormWrapper";
...
const ATMAppHeader = (props: Props) => {
  ...
  const { userData, isOpenChangePassword } = useSelector(
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-4">
        ...
        <div className="text-2xl font-bold text-primary-main"> Ivisa </div>
      </div>
